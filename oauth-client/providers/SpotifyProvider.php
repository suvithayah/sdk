...
class SpotifyProvider {
    ...
    public static $redirect_uri = "https://localhost/auth-bitly-success";
    public static $scope = "";
    public static $client_id = "";
    public static $client_secret = "";
    public static $link = "https://bitly.com/oauth/authorize";
    ...
    public static function getPath()
    {
        /* return "<a href='" . self::$link 
            . "response_type=code"
            . "&client_id=t2ikjrr1xcxjohm"
            . "&state=" . OAuth::getState()
            . "&scope=account_info.read"
            . "&redirect_uri=https://localhost/auth-bitly-success'>Se connecter avec Bitly</a>"; */

        return "<a href=" . self::$link . "?"
            . "client_id=" . self::$client_id
            . "&state=" . OAuth::getState()
            . "&redirect_uri=" . self::$redirect_uri . ">Se connecter avec Bitly</a>";
    }    
